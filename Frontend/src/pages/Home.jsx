    ...
    <div className="h-screen relative overflow-hidden">
      ...
      <div className=" flex flex-col justify-end absolute h-screen top-0 w-full">
        <div className="h-[30%] p-6 bg-white relative">
          ...
          >
            <div className="line absolute h-16 w-1 bg-gray-700 top-[45%] left-10 rounded-full"></div>
            <input
              onClick={() => {
                setPanelOpen(true);
              }}
      ...
      >
        ...
        <div className="flex border-2 active:border-black mb-2 rounded-xl w-full items-center p-3 justify-between">
          <img
            className="h-10"
          ...
          <div className="ml-2 w-1/2">
            ...
            <h5 className="font-medium text-sm">2 mins away from you</h5>
        ...
        <div className="flex border-2 active:border-black mb-2 rounded-xl w-full items-center p-3 justify-between">
          ...
          <div className="ml-2 w-1/2">
            ...
            <h5 className="font-medium text-sm">10 mins away from you</h5>
            <p className="font-normal text-xs text-gray-600">
